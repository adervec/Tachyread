...
// Procedural animated reader face. The eye/brow/lid/mouth "rig" is shared across every
// style and animates with WPM; each FaceStyle layers distinctive decorations around it.
// ArtStyle re-skins the whole face (Flat/Sketch/Neon/Watercolor/Pastel). Ported in spirit
// from SPRITZApp/MainWindow.xaml.cs BuildFace* (SVG instead of WPF Canvas).

const { LCx, RCx, ECy, ScR, IrisR, PupilR, GlowR } = RIG;

// ── Per-style decoration table ──────────────────────────────────────────────
// Each entry: { skin, stroke, brow, sclera?, bg:[], fg:[], hideNose?, noseHair? }
// bg renders behind the eyes, fg in front (whiskers, masks, hair over forehead).
